...
const Chat = () => {
  ...
  return (
    <div
      id="chat"
      className={`${
        isClicked.chat ? "top-16 visible" : "-top-[1000px] invisible"
      } nav-item w-96 absolute right-5 md:right-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg shadow-2xl transition-all duration-500`}
    >
